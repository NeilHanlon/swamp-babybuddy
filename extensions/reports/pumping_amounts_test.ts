...
import { report } from "./pumping_amounts.ts";

Deno.test("pumping_amounts report identity and no-snapshot path", async () => {
  assertEquals(report.name, "@kneel/babybuddy-pumping-amounts");
