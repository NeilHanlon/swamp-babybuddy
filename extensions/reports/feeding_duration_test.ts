...
import { report } from "./feeding_duration.ts";

Deno.test("feeding_duration report identity and no-snapshot path", async () => {
  assertEquals(report.name, "@kneel/babybuddy-feeding-duration");
