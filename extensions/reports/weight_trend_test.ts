...
import { report } from "./weight_trend.ts";

Deno.test("weight_trend report identity and no-snapshot path", async () => {
  assertEquals(report.name, "@kneel/babybuddy-weight-trend");
