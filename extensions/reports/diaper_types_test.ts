...
import { report } from "./diaper_types.ts";

Deno.test("diaper_types report identity and no-snapshot path", async () => {
  assertEquals(report.name, "@kneel/babybuddy-diaper-types");
